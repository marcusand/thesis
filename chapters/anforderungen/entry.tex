...
\begin{figure}
    ...
    \caption{Schablone für die funktionalen Anforderungen}
    \label{fig:schablone-funktion}
\end{figure}

Die Anforderungen sind in natürlicher Sprache verfasst und folgen dabei einer bestimmten Syntax. Diese
Syntax folgt den Schablonenregeln von \citeext{requirements}.


\iffalse
- Um die Möglichkeiten und Grenzen dieser Technologien strukturiert und genau bewerten zu können,
  werden im ersten Schritt die Anforderungen an das System, und genauer an die Software des Systems,
  analysiert. 
...
- Funktionale Anforderungen sind immer sehr Projekt spezifisch, während nicht-funktionale 
  Anforderungen allgemeiner und übertragbarer sind. 
- Funktionale Anforderungen stellen Forderungen an das Gesamtsystem und geben Antwort auf die 
  Frage "Was soll das System machen". Alle weiteren Anforderungen bezeichnet man als nicht-funktionale
  Anforderungen (S.19 kompakt)
