...
\begin{enumerate}[label=\textbf{NFA\arabic*}]
  ...
  Oberfläche zwischenzeitlich nicht bedienbar ist, würde dazu führen, dass viele Nutzer*innen sich 
  ...
  Fehlermeldung angezeigt werden, welche die Nutzer*innnen darauf hinweist, es später noch einmal zu versuchen.
  ...
  Diese Anforderung gilt genauso für die \shst{}. Den Nutzer*innen soll keine Möglichkeit geboten werden, die
