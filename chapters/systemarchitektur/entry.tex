...
Bei diesem handelt es sich um einen Cloud-Server mit Root-Zugriff. Zum einen ist auf diesem das CMS zusammen
mit der Datenbank gehostet und zum anderen ein Webserver welcher die Applikationsfiles der \emph{Sharing
Station App} ausliefert. Beide kommunizieren über das HTTPS-Protokoll mit der Clientapplikation.\\
